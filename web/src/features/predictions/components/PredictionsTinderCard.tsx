...
interface PredictionsTinderCardProps {
  match: Match;
  homeGoals: number;
  awayGoals: number;
...
export function PredictionsTinderCard({
  match,
  homeGoals,
  awayGoals,
  onGoalsChange,
            ...
            <div>
              ...
              <div className="flex items-center justify-center gap-4 mt-3">
                ...
                <button
                  ...
                  onClick={() => adjust('home', 1)}
                  disabled={disabled}
                  className="w-12 h-12 rounded-full bg-slate-700 hover:bg-slate-600 disabled:opacity-40 text-2xl font-bold flex items-center justify-center"
